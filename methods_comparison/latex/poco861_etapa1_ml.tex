...
\subsection{O que o $R^2$ informa}

O $R^2$ compara o modelo com a média do treino.
Perto de 1, acompanha a variação do alvo; perto de 0, equivale a
prever essa média. Valor negativo não é ``ajuste fraco'': o modelo
erra \emph{mais} do que a média --- falha preditiva.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\linewidth]{figures/fig1_fzi_log_correlations}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.78\linewidth]{figures/fig1_fzi_oracle_vs_logs}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.82\linewidth]{figures/fig1_target_comparison_r2}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[t]{0.48\linewidth}
    \centering
    \includegraphics[width=\linewidth]{figures/fig1_phi_rf_pred_vs_obs}
  ...
  \begin{subfigure}[t]{0.48\linewidth}
    \centering
    \includegraphics[width=\linewidth]{figures/fig1_phi_shap_bar}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.72\linewidth]{figures/fig1_ct_plugs_fzi_wireline}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.78\linewidth]{figures/fig1_phi_model_comparison}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[t]{0.48\linewidth}
    \centering
    \includegraphics[width=\linewidth]{figures/fig1_hfu_classifier_oof}
  ...
  \begin{subfigure}[t]{0.48\linewidth}
    \centering
    \includegraphics[width=\linewidth]{figures/fig1_hfu_confusion_logistic}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{figures/fig1_clp_three_methods_depth_panels.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.62\linewidth]{figures/fig1_clp_three_methods_depth_overlay.png}
...
\paragraph{Leitura para o modelo petrofísico.}
...
\begin{enumerate}
  ...
  \item \textbf{FZI:} não usar previsão direta a partir de perfis como
        modelo final. O perfil não carrega informação suficiente.

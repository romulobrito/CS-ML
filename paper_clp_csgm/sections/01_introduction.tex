...
hard evidence about the reconstructed signal.
...
\end{equation}
The first term enforces sparse core consistency; the second term keeps the
...
\begin{itemize}
  ...
  and in a real-well F03-4 porosity benchmark using gamma ray only as dense
  input.
  \item We show that CLP-CSGM Ridge improves over strong direct baselines in
  sparse-measurement regimes and discuss when direct autoencoder regression
  remains competitive.
\end{itemize}
